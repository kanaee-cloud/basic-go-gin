...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/publishers": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.SuccessResponse-array_dto_PublisherDetailResp"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Publisher's details",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.SuccessResponse-dto_PublisherDetailResp"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "dto.SuccessResponse-array_dto_PublisherDetailResp": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.PublisherDetailResp"
                    }
                },
                "message": {
                    "type": "string"
        ...
        "dto.SuccessResponse-dto_PublisherDetailResp": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/dto.PublisherDetailResp"
